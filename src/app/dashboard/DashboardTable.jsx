...
const DashboardTable = () => {
  return (
    <>
      <div className="border w-full h-fit bg-white rounded-md hover:shadow-xl shadow flex justify-center flex-col space-y-3 p-5">
          ...
          <table className="min-w-full">
            <thead>
              <tr className="bg-blue-gray-100 text-gray-700">
                ...
                <th className="py-3 px-4 text-left">Inquiry Status</th>
            ...
            <tbody className="text-blue-gray-900">
              <tr className="border-b border-blue-gray-200">
                ...
                <td className="py-3 px-4">Trailer</td>
                <td className="py-3 px-4">Product</td>
                <td className="py-3 px-4  space-x-3 text-green-600">
                  &#x2022; Answered{" "}
                </td>
