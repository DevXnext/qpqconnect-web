  ...
  <>
   <div className="border w-full h-fit rounded-md hover:shadow-xl shadow flex justify-center flex-col space-y-3 p-5">
        <div className="flex flex-row justify-between items-center border-b-2 pb-2">
          <h2 className="text-lg font-semibold">All Inquiry</h2>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="bg-blue-gray-100 text-gray-700">
                ...
                <th className="py-3 px-4 text-left">Quantity Unit</th>
                <th className="py-3 px-4 text-left">Queries</th>
            ...
            <tbody className="text-blue-gray-900">
              <tr className="border-b border-blue-gray-200">
                ...
                <td className="py-3 px-4 font-semibold text-blue-800">#A46</td>
                <td className="py-3 px-4 font-semibold">Dec 25, 2024</td>
                <td className="py-3 px-4"> Truck Trailer</td>
                <td className="py-3 px-4">50</td>
                <td className="py-3 px-4">Pieces</td>
                <td className="py-3 px-4  space-x-3 text-green-600"> &#x2022; 2 Queries</td>
              ...
              <tr className="border-b border-blue-gray-200">
                ...
                <td className="py-3 px-4 font-semibold text-blue-800">#A46</td>
                <td className="py-3 px-4 font-semibold">Dec 26, 2024</td>
                <td className="py-3 px-4"> Truck Trailer</td>
...
export default withAuth(RFQOutgoing)