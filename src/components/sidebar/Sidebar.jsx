...
const Sidebar = () => {
  ...
  return (
    <>
        ...
        <div
          className={`flex flex-col space-y-5 p-5 md:w-${
            isSidebarOpen ? "70" : "12"
          } text-white shadow h-100% bg-gray-900 transition-all duration-300 ease-in-out`}
        >
          ...
          <div className="flex flex-col space-y-2 text-[18px]">
            ...
            hover:text-black stroke-white justify-${
              isSidebarOpen ? "center" : "left"
            } rounded-lg hover:stroke-black py-2 px-5 w-full
            ${
              pathname === "/dashboard"
